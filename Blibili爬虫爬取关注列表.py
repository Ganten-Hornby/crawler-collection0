...
fans = []
with open('fans.txt', 'r', encoding='utf-8') as f:
    lines = f.readlines()
    # print(lines)
    for line in lines[1:]:
        fans.append(line.split()[1])
with open('followers.txt', 'w', encoding='utf-8') as f1:
    for count, userlink in enumerate(fans):
        driver.get('https:' + userlink + 'fans/follow')
        followers = []
        print(count)
        while True:
